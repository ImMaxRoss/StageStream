...
public class UserServiceImpl implements UserService {
	...
	public UserDTO registerUser(UserDTO userDTO) {
		...
		try {
			...
			Address address = addressRepo.findByStateAndCityAndZipcodeAndStreet(state,
					city, zipcode, street);

			if (address == null) {
				address = new Address(state, city, zipcode, street);
	...
	public UserDTO updateUser(Long userId, UserDTO userDTO) {
		...
		if (userDTO.getAddress() != null) {
			...
			if (address == null) {
				address = new Address(state, city, pincode, street);
